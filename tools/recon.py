...
def main():
    ...
    for eval_cfg in cfg.evaluation:
        ...
        cfg.data['train'].update({'code_dir':'/home/zhangweitian/HighResAvatar/cache/ssdnerf_avatar_uncond_16bit_thuman_conv_final/code'})
        ...
        viz_dir = os.path.join(os.path.dirname(eval_cfg.get('viz_dir', None)), 'val_recon')
        log_vars = recon_3d(
